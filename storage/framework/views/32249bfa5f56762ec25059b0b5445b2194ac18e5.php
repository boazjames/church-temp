    ...
    <div class="inline quick-links float-right">
        ...
        <div class="position-absolute messages hidden">
            <ul>
                ...
                <li class="text-bold">You have <?php echo e(count($unread_messages)); ?> new messages</li>
                    <?php $count=0  ?>
                <?php $__currentLoopData = $unread_messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unread_message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $count++  ?>

                <li class="single-message" data-id="<?php echo e($unread_message->id); ?>"><a><span><?php echo e($unread_message->email); ?></span>
                        <br>
                        <span class="color-light"><?php echo e(str_limit($unread_message->message,$limit=60,$end='...')); ?></span>
                        <div><i class="fa fa-clock-o"></i> <?php echo e($unread_message->created_at->diffForHumans()); ?></div></a></li>
                        <?php if($count==3): ?>
                            <?php break; ?>
                        <?php endif; ?>
